import { BadgeCheck, Building2, Briefcase, Users } from 'lucide-react'
...
export function SettingsPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title="Configuración"
        description="Administra la iglesia, miembros, cargos y ministerios desde secciones separadas."
      />

      <Tabs defaultValue="general" className="page-enter stagger-1 w-full">
        <div className="overflow-x-auto pb-1">
          <TabsList className="inline-flex h-auto w-max min-w-full gap-1 sm:grid sm:w-full sm:grid-cols-2 lg:grid-cols-4">
